 ...
 */
public class WarehouseReceiveIn implements configMFC {
  //  @BeforeClass
  ...
  //  @Test(priority=1,dataProviderClass = DataProviders.class, dataProvider = "createFileForNewClient")
    public void createWarehouseReceiveIn(By locatorlanguage, String bookingType, String source, String jobType,
