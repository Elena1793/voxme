 ...
 */
public class PickupFromTerminal implements configMFC {
  //  @BeforeClass
  ...
  @Test(priority=1,dataProviderClass = DataProviders.class,dataProvider = "createFileForNewClient_new")
    public void createPickupFromTerminal(By locatorlanguage, String bookingType, String source, String jobType,
    ...
    private void generateReport() throws InterruptedException {
        ...
        appMFC.Quotation_metods().click(By.xpath("//div[@id='reportButton']"));
            ...
            appMFC.getPickupFromTerminal_Metods()
                    .click(By.xpath("//li[starts-with(@class,'k-item k-menu-item k-state-default reportButtonMenuItem k-first k-last')]"));
    }
